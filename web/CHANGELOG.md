...
| Version | PR | Contenu |
|---|---|---|
| **1.11.0** | — | **Calibrage de la fiche Cible** : le champ « Signaux recherchés » devient un textarea **un signal par ligne** (fini le découpage sur les virgules qui cassait les phrases — la fiche Rossini avait 2 signaux coupés en 4, réparés en base) |
