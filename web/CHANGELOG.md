...
| Version | PR | Contenu |
|---|---|---|
| **1.14.0** | — | **File d'appels du jour** : l'accueil ouvre sur « qui j'appelle ce matin, et pourquoi » — top 10 priorisé (réponses chaudes > bascule téléphone > relances dues > top leads jamais contactés), angle d'attaque en une phrase, téléphone cliquable (`tel:`) ou accès fiche pour enrichir |
