// Mapping statique département → région (métropole + Corse + DOM), pour les
// classements par région de l'onglet Bornes VE. Codes INSEE (2A/2B pour la Corse).
...
export function regionDe(dept: string): string {
  return DEPT_REGION[dept] ?? "Autre / inconnu";
}
